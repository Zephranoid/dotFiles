...
## Type: Font
c.fonts.monospace = '"Tamsyn","xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
## Type: FontFamily
c.fonts.web.family.cursive = '"Tamsyn"'
...
#Custom bindings
config.bind('M', 'hint links spawn nohup mpv {hint-url} --loop=inf')
